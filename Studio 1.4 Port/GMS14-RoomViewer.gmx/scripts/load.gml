...
This code is a ported version from the Studio 2 version, and there
are many formatting issues. There is only one modified line.
...
if(header == "You ")
log("You must swap game.win with the real data file.");
return -1;
